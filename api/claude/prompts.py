...
_PREAMBLE = (
    ...
    "Extrae el valor EXACTAMENTE como aparece en la factura, SIN convertir ni dividir nunca. "
    "Detecta la unidad indicada en la factura y rellena el campo 'pp_unidad': "
    "  'dia'  → si la factura muestra €/kW·día o €/kW/día. "
    "  'anio' → si la factura muestra €/kW·año o €/kW/año. "
    "  'mes'  → si la factura muestra €/kW·mes o €/kW/mes. "
    "  'anio' → si no hay unidad indicada (asumir año). "
    "Añadir en otros.observacion: 'pp_unidad detectada: [unidad]. Valores extraídos tal como aparecen en la factura.' "
    "SUB-PERÍODOS (Energía XXI): media ponderada por días sin convertir. "
